                ...
                <!-- <p>Admin template with very clean and aesthetic style prepared for your next app. </p> -->
                    ...
                    <div class="flash-message">
                        @foreach (['danger', 'warning', 'success', 'info'] as $msg)
                          ...
                          <p class="alert alert-{{ $msg }}">{{ Session::get('alert-' . $msg) }} <a href="{{ route('addproperty') }}" class="close" data-dismiss="alert" aria-label="close">&times;</a></p>
                          @endif
                        @endforeach
                    </div> 
                    ...
                    <form method="post" action="{{ route('storeaddproperty') }}" id="loginForm" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <span class="error">{{ $errors->first('view') }}</span>
                            </div>
                            <div class="form-group col-lg-6">
                                <label>Owner</label>
