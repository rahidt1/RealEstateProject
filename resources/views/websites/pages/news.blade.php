...
<!-- Home -->
	...
	<div class="home">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="{{ asset('/webstyle/images/news12.jpg') }}" data-speed="0.8"></div>
				...
				<div class="col-lg-8">
					<div class="news_posts">
						...
						<div class="news_post">
							...
							<div class="news_post_image"><img src="{{ asset('/webstyle/images/news_1.jpg') }}" alt=""></div>
						...
						<div class="news_post">
							...
							<div class="news_post_image"><img src="{{ asset('/webstyle/images/news_2.jpg') }}" alt=""></div>
							<div class="news_post_text">
								<p>Donec ullamcorper nulla non metus auctor fringi lla. Curabitur blandit tempus porttitor.Sed lectus urna, ultricies sit amet risus eget, euismod imperdiet augue. Duis imperdiet, purus a pellentesque sodales, sapien mauris rhoncus eros, ac blandit elit leo ac diam.</p>
							</div>
						</div>
						...
						<div class="news_post">
							...
							<div class="news_post_image"><img src="{{ asset('/webstyle/images/news_3.jpg') }}" alt=""></div>
							<div class="news_post_text">
								<p>Donec ullamcorper nulla non metus auctor fringi lla. Curabitur blandit tempus porttitor.Sed lectus urna, ultricies sit amet risus eget, euismod imperdiet augue. Duis imperdiet, purus a pellentesque sodales, sapien mauris rhoncus eros, ac blandit elit leo ac diam.</p>
							</div>
						</div>
						...
						<div class="sidebar_latest">
							...
							<div class="sidebar_latest_posts">
								...
								<div class="latest_post d-flex flex-row align-items-start justify-content-start">
									<div><div class="latest_post_image"><img src="{{ asset('/webstyle/images/latest_1.jpg') }}" alt=""></div></div>
								...
								<!-- Recent Post -->
								<div class="latest_post d-flex flex-row align-items-start justify-content-start">
									<div><div class="latest_post_image"><img src="{{ asset('/webstyle/images/latest_2.jpg') }}" alt=""></div></div>
									<div class="latest_post_content">
										<div class="latest_post_date"><a href="#">April 02, 2018</a></div>
								...
								<!-- Recent Post -->
								<div class="latest_post d-flex flex-row align-items-start justify-content-start">
									<div><div class="latest_post_image"><img src="{{ asset('/webstyle/images/latest_3.jpg') }}" alt=""></div></div>
									<div class="latest_post_content">
										<div class="latest_post_date"><a href="#">April 02, 2018</a></div>
								...
								<!-- Recent Post -->
								<div class="latest_post d-flex flex-row align-items-start justify-content-start">
									<div><div class="latest_post_image"><img src="{{ asset('/webstyle/images/latest_4.jpg') }}" alt=""></div></div>
									<div class="latest_post_content">
										<div class="latest_post_date"><a href="#">April 02, 2018</a></div>
