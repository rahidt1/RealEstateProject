...
@section('abc')
	...
	<!-- Home -->
	<div class="home">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="{{asset('/webstyle/images/about.jpg')}}" data-speed="0.8"></div>
	...
	<div class="about">
		<div class="container">
			<div class="row">
				...
				<!-- About Image -->
				<div class="col-lg-6">
					<div class="about_image"><img src="{{ asset('/webstyle/images/about_image.jpg') }}" alt=""></div>
				</div>
			</div>
			<div class="row milestones_row">
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone d-flex flex-row align-items-center justify-content-start">
						<div class="milestone_icon d-flex flex-column align-items-center justify-content-center"><img src="{{ asset('/webstyle/images/milestones_1.png') }}" alt=""></div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone d-flex flex-row align-items-center justify-content-start">
						<div class="milestone_icon d-flex flex-column align-items-center justify-content-center"><img src="{{ asset('/webstyle/images/milestones_2.png') }}" alt=""></div>
						<div class="milestone_content">
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone d-flex flex-row align-items-center justify-content-start">
						<div class="milestone_icon d-flex flex-column align-items-center justify-content-center"><img src="{{ asset('/webstyle/images/milestones_3.png') }}" alt=""></div>
						<div class="milestone_content">
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone d-flex flex-row align-items-center justify-content-start">
						<div class="milestone_icon d-flex flex-column align-items-center justify-content-center"><img src="{{ asset('/webstyle/images/milestones_4.png') }}" alt=""></div>
						<div class="milestone_content">
			...
			<div class="row realtors_row">
				...
				<div class="col-lg-3 col-md-6">
					<div class="realtor_outer">
						<div class="realtor">
							<div class="realtor_image"><img src="{{ asset('/webstyle/images/realtor_1.jpg') }}" alt=""></div>
				...
				<div class="col-lg-3 col-md-6">
					<div class="realtor_outer">
						<div class="realtor">
							<div class="realtor_image"><img src="{{ asset('/webstyle/images/realtor_2.jpg') }}" alt=""></div>
							<div class="realtor_body">
				...
				<div class="col-lg-3 col-md-6">
					<div class="realtor_outer">
						<div class="realtor">
							<div class="realtor_image"><img src="{{ asset('/webstyle/images/realtor_3.jpg') }}" alt=""></div>
							<div class="realtor_body">
				...
				<div class="col-lg-3 col-md-6">
					<div class="realtor_outer">
						<div class="realtor">
							<div class="realtor_image"><img src="{{ asset('/webstyle/images/realtor_4.jpg') }}" alt=""></div>
							<div class="realtor_body">
