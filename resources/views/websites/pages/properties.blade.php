		...
		<div class="container">
			...
			<div class="row properties_row">
				...
				<div class="col-xl-4 col-lg-6 property_col">
					<div class="property">
						...
						<div class="property_footer d-flex flex-row align-items-center justify-content-start">
							<div><div class="property_icon"><img src="{{ asset('/webstyle/images/icon_1.png') }}" alt=""></div><span>650 Ftsq</span></div>
							<div><div class="property_icon"><img src="{{ asset('/webstyle/images/icon_2.png') }}" alt=""></div><span>3 Bedrooms</span></div>
							<div><div class="property_icon"><img src="{{ asset('/webstyle/images/icon_3.png') }}" alt=""></div><span>3 Bathrooms</span></div>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-4 col-lg-6 property_col">
					<div class="property">
						<div class="property_image">
							<img src="{{ asset('/webstyle/images/property_4.jpg') }}" alt="">
				...
				<div class="col-xl-4 col-lg-6 property_col">
					<div class="property">
						<div class="property_image">
							<img src="{{ asset('/webstyle/images/property_5.jpg') }}" alt="">
						</div>
						<div class="property_body text-center">
				...
				<div class="col-xl-4 col-lg-6 property_col">
					<div class="property">
						<div class="property_image">
							<img src="{{ asset('/webstyle/images/property_6.jpg') }}" alt="">
						</div>
						<div class="property_body text-center">
							<div class="property_location">Miami</div>
							<div class="property_title"><a href="property.html">Sea view property</a></div>
				...
				<div class="col-xl-4 col-lg-6 property_col">
					<div class="property">
						<div class="property_image">
							<img src="{{ asset('/webstyle/images/property_7.jpg') }}" alt="">
							<div class="tag_new property_tag"><a href="#">New</a></div>
						</div>
						<div class="property_body text-center">
							<div class="property_location">Miami</div>
				...
				<div class="col-xl-4 col-lg-6 property_col">
					<div class="property">
						<div class="property_image">
							<img src="{{ asset('/webstyle/images/property_8.jpg') }}" alt="">
						</div>
						<div class="property_body text-center">
				...
				<div class="col-xl-4 col-lg-6 property_col">
					<div class="property">
						<div class="property_image">
							<img src="{{ asset('/webstyle/images/property_9.jpg') }}" alt="">
						</div>
						<div class="property_body text-center">
							<div class="property_location">Miami</div>
							<div class="property_title"><a href="property.html">Sea view property</a></div>
